...
func (c *secGroupServiceClient) FindSgIcmpRules(ctx context.Context, in *FindSgIcmpRulesReq, opts ...grpc.CallOption) (*SgIcmpRulesResp, error) {
	...
	err := c.cc.Invoke(ctx, "/hbf.v1.sgroups.SecGroupService/FindSgIcmpRules", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *secGroupServiceClient) FindSgSgIcmpRules(ctx context.Context, in *FindSgSgIcmpRulesReq, opts ...grpc.CallOption) (*SgSgIcmpRulesResp, error) {
	...
	err := c.cc.Invoke(ctx, "/hbf.v1.sgroups.SecGroupService/FindSgSgIcmpRules", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *secGroupServiceClient) FindCidrSgRules(ctx context.Context, in *FindCidrSgRulesReq, opts ...grpc.CallOption) (*CidrSgRulesResp, error) {
	...
	err := c.cc.Invoke(ctx, "/hbf.v1.sgroups.SecGroupService/FindCidrSgRules", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *secGroupServiceClient) FindSgSgRules(ctx context.Context, in *FindSgSgRulesReq, opts ...grpc.CallOption) (*SgSgRulesResp, error) {
	...
	err := c.cc.Invoke(ctx, "/hbf.v1.sgroups.SecGroupService/FindSgSgRules", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *secGroupServiceClient) FindCidrSgIcmpRules(ctx context.Context, in *FindCidrSgIcmpRulesReq, opts ...grpc.CallOption) (*CidrSgIcmpRulesResp, error) {
	...
	err := c.cc.Invoke(ctx, "/hbf.v1.sgroups.SecGroupService/FindCidrSgIcmpRules", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SecGroupService_FindSgIcmpRules_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hbf.v1.sgroups.SecGroupService/FindSgIcmpRules",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SecGroupService_FindSgSgIcmpRules_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hbf.v1.sgroups.SecGroupService/FindSgSgIcmpRules",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SecGroupService_FindCidrSgRules_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hbf.v1.sgroups.SecGroupService/FindCidrSgRules",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SecGroupService_FindSgSgRules_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hbf.v1.sgroups.SecGroupService/FindSgSgRules",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SecGroupService_FindCidrSgIcmpRules_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hbf.v1.sgroups.SecGroupService/FindCidrSgIcmpRules",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
