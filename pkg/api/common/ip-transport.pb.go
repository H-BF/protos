...
// Enum value maps for IPv.
var (
	IPv_name = map[int32]string{
		0: "_",
		1: "V4",
		2: "V6",
	}
	IPv_value = map[string]int32{
		"_":  0,
		"V4": 1,
		"V6": 2,
	}
...
func (x IPv) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (IPv) Descriptor() protoreflect.EnumDescriptor {
	return file_common_ip_transport_proto_enumTypes[0].Descriptor()
}

func (IPv) Type() protoreflect.EnumType {
	return &file_common_ip_transport_proto_enumTypes[0]
}

func (x IPv) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use IPv.Descriptor instead.
func (IPv) EnumDescriptor() ([]byte, []int) {
...
type ICMP struct {
	...
	IPv   IPv      `protobuf:"varint,1,opt,name=IPv,proto3,enum=common.IPv" json:"IPv,omitempty"`
...
var file_common_ip_transport_proto_rawDesc = []byte{
	...
	,
...
var file_common_ip_transport_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
...
var file_common_ip_transport_proto_goTypes = []interface{}{
	(IPv)(0),                         // 0: common.IPv
	(Networks_NetIP_Transport)(0),    // 1: common.Networks.NetIP.Transport
	(*Networks)(nil),                 // 2: common.Networks
	(*ICMP)(nil),                     // 3: common.ICMP
	(*Networks_NetIP)(nil),           // 4: common.Networks.NetIP
	(*Networks_NetIP_PortRange)(nil), // 5: common.Networks.NetIP.PortRange
}
var file_common_ip_transport_proto_depIdxs = []int32{
	0, // 0: common.ICMP.IPv:type_name -> common.IPv
...
func file_common_ip_transport_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_common_ip_transport_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
